...
#
dot_product:
        fcvt.s.wu 	ft0, zero	# ft0 = sum = 0.0
        add		t1, x0, x0	# t1 = i = 0
loop:
        slli		t2, t1, 2	# t2 = offset
        
        add		t5, a0, t2	# t5 = x address
        flw		ft3, 0(t5)	# ft3 = x[i]
        
        add		t5, a1, t2	# t5 = y address
        flw		ft4, 0(t5)	# ft4 = y[i]
        
        fmul.s		ft4, ft3, ft4	# ft4 = x[i] * y[i]
        fadd.s 		ft0, ft0, ft4	# sum += x[i] * y[i]
        ...
        #return
        fcvt.s.wu 	ft1, zero	# ft1 = 0 (float)
        fadd.s 		fa0, ft0, ft1	# fa0 = sum
        jalr		x0, ra, 0	# return
